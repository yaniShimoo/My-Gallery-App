...
public class SMSIncomReceiverOld extends BroadcastReceiver {
   Context context;
    ...
    public void onReceive(Context context, @NonNull Intent intent) {
        ...
        if (action.equals("android.provider.Telephony.SMS_RECEIVED") && extras != null && extras.containsKey("pdus")){
